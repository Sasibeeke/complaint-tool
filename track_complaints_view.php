                    ...
                    if(isset($_SESSION['message']))
                        { 
                            ...
                            //unset($_SESSION['message']);
                                ...
                                <h4 class="header-title">Track Complaints</h4>
                                <div class="data-tables">
									...
									and c.floor_coordinator_empno=f.floor_coordinator_empno  and c.section_code='$section_code'";
									}elseif($floor_no!=NULL){	
									$sql = "select c.complaint_no,s.section_name,c.floor_no,f.floor_coordinator_name,f.floor_coordinator_designation,c.location_in_floor,
									c.nature_of_complaint,c.complaint_date,c.flag,c.description from complaint_tbl c,floor_tbl f,section_tbl s where c.section_code=s.section_code 
									and c.floor_coordinator_empno=f.floor_coordinator_empno  and c.floor_no='$floor_no'";
									}else{
									$sql = "select c.complaint_no,s.section_name,c.floor_no,f.floor_coordinator_name,f.floor_coordinator_designation,c.location_in_floor,
									c.nature_of_complaint,c.complaint_date,c.flag,c.description from complaint_tbl c,floor_tbl f,section_tbl s where c.section_code=s.section_code 
									and c.floor_coordinator_empno=f.floor_coordinator_empno";	
									}									
									//echo $sql;die();
								...
								<?php 		
										...
										while($row = mysqli_fetch_assoc($result)) {
							                ...
							                <ul class="d-flex justify-content-center">
							                  <a href="track_complaint_details.php?id='.$row['complaint_no'].'"><span class="status-p bg-primary">Details</span></a>
															 </ul>
								                 </td>
