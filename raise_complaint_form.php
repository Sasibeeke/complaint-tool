                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    ...
                                    <form class="needs-validation" novalidate="" action="complaint_submit.php" method="POST" >
										...
										<div class="form-group">
                                            <label for="validationCustom04" class="col-form-label">Complaint Location In Floor</label>
										...
										<div class="form-group">
                                            ...
                                            <textarea class="form-control" type="text" value="" name="remarks" id="validationCustom05" placeholder="Enter Complaint details" required=""></textarea>
											<div class="invalid-feedback">
