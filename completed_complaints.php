        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
					        ...
					        if(isset($_SESSION['message']))
					             ...
					             <h4 class="header-title">View Completed Complaints</h4>
					             <div class="data-tables">
					             <?php
									$section_code=$_SESSION['section_code'];	
									$sql = "select c.complaint_no,s.section_name,c.floor_no,f.floor_coordinator_name,f.floor_coordinator_designation,c.location_in_floor,c.nature_of_complaint,c.complaint_date,c.flag,c.description from complaint_tbl c,floor_tbl f,section_tbl s where c.section_code=s.section_code and c.floor_coordinator_empno=f.floor_coordinator_empno  and c.flag='2' and c.section_code='$section_code'";
									//echo $sql;die();
                ...
                <ul class="d-flex justify-content-center">
                   ...
                   <a href="completed_details.php?id='.$row['complaint_no'].'"><span class="status-p bg-primary">Details</span></a>
															 </ul>
                 </td>';	
